...
public struct TSStyle {
    ...
    public init(colorsX: [UIColor] = [UIColor.randomColor(), UIColor.randomColor(), UIColor.randomColor()],
        ...
        self.fillColorClosure = fillColorClosure ?? TSStyle.gradientColorClosure(colorsX: colorsX, colorsY: colorsY)
        self.strokeColorClosure = strokeColorClosure ?? TSStyle.gradientColorClosure(colorsX: colorsX, colorsY: colorsY)
