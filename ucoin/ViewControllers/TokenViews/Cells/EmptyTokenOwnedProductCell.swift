//
//  EmptyTokenOwnedProductCell.swift
//  ucoin
//
...
final class EmptyTokenOwnedProductCell: UITableViewCell, Reusable {
    ...
    private lazy var containerView: UIView = {
        ...
        createButton.addTarget(self, action: #selector(showCreateTokenProduct), for: .touchUpInside)
...
// Actions Section
extension EmptyTokenOwnedProductCell {
    
    @objc private func showCreateTokenProduct() {
        if let delegate = self.delegate {
            delegate.showCreateTokenProduct()
        }
    }
